...
;
;
function MediaGallery({ initialMedias }) {
    _s();
    ...
    // Logique de tri automatique dès que sortBy change
    const sortedMedias = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MediaGallery.useMemo[sortedMedias]": ()=>{
            const list = [
                ...initialMedias
            ];
            return list.sort({
                "MediaGallery.useMemo[sortedMedias]": (a, b)=>{
...
_s(MediaGallery, "277lvn1143hkTriw9HqXVOev66I=");
_c = MediaGallery;
var _c;
...
//# sourceMappingURL=src_app_photographes_%5Bid%5D_page_83875443.js.map